package org.example.follower_2.poji;
...
public class MessageSport implements Serializable {
    ...
    public MessageSport(Integer id, double leader_x, double leader_y, double leader_theta, double leader_v, double leader_w, String flag1, String flag2) {
        this.id = id;
